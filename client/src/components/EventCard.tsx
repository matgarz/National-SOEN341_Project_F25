...
export function EventCard({
    ...
    const getAvailabilityStatus = () => {
        ...
        if (remaining < 10)
            return {text: `${remaining} left`, color: "text-orange-600"};
    ...
    return (
        ...
        >
            <Card
                className="overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 border-0 bg-white/70 backdrop-blur-sm">
            ...
            />*/}
                    ...
                    <div className="absolute top-2 left-2">
                        ...
                        >
                            <Badge
                                className={`${getCategoryColor(event.category)} shadow-sm backdrop-blur-sm`}
                            >
                                {event.category}
                            </Badge>
                        </motion.div>
                ...
                <CardHeader className="pb-2">
                    <div className="flex items-start justify-between">
                        ...
                        {event.ticketType === "free" && (
                            <Badge
                                variant="outline"
                                className="ml-2 shrink-0 text-green-600 border-green-200"
                            >
                                Free
                            </Badge>
                        )}
