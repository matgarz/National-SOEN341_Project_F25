...
import {Item, ItemContent, ItemFooter, ItemHeader, ItemMedia} from "./ui/item";
...
export function Comments({ eventId }: CommentsProps) {
    ...
    const submitComment = async (event: React.FormEvent) => {
        ...
        setAlerts([]);
        if(!user) {
            setAlerts(prev => prev.concat("Error loading user, consider signing out and logging back in"));
            return;
        }
